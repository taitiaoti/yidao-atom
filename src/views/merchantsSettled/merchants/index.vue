<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container" v-if="business_enterprise_add">
      <el-button class="filter-item" @click="openAdd" type="primary" icon="edit"
        >添加
      </el-button>
      <el-button
        class="filter-item"
    ...
    <div class="filter-container">
      ...
      <div class="s-category">
        <el-select
          v-model="searchObj.isFreePostage"
          placeholder="请选择店铺状态"
        >
          <el-option
    ...
    >
      ...
      <el-table-column align="center" label="关键词搜索">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="店铺图标" width="120">
        <template slot-scope="scope">
          <img
            :src="
              scope.row.iconUrl.indexOf('http') == 0
                ? scope.row.iconUrl
                : baseUrl + scope.row.iconUrl
            "
            height="100"
            width="100"
          />
      ...
      <el-table-column align="center" label="嘟嘟用户手机号">
        <template slot-scope="scope">
          <span>{{ scope.row.keywords }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="收款渠道">
        <template slot-scope="scope">
          <span>{{ scope.row.keywords }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="优惠折扣（百分比）">
        <template slot-scope="scope">
          <span>{{ scope.row.keywords }}</span>
        </template>
      </el-table-column> -->
      ...
      <el-table-column align="center" label="人均消费">
        <template slot-scope="scope">
          <span>{{
            scope.row.averageConsumption | filterAverageConsumption
          }}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column align="center" label="打印机编号">
        <template slot-scope="scope">
          <span>{{ scope.row.propaganda }}</span>
        </template>
      </el-table-column> -->
      ...
      <el-table-column label="操作" align="center" width="280">
        <template slot-scope="scope">
          <!-- <el-button
            v-if="business_enterprise_editor"
            size="small"
            type="success"
