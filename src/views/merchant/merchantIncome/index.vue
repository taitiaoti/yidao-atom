<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
        ...
        <div class="s-category">
          <el-select v-model="riderOrderStatus" placeholder="请选择订单状态" clearable>
            <el-option
      ...
      <el-table
        ...
        <el-table-column align="center" label="订单状态">
          <template scope="scope">
            <el-tag>{{scope.row.riderOrderStatus | filterOrderStatus}}</el-tag>
          </template>
        </el-table-column>
      </el-table>
      <!--主体展示部分的结束 -->
  ...
  methods: {
    ...
    getList(){
      ...
      let postData = {
        ...
        riderOrderStatus: this.riderOrderStatus,
        ...this.listQuery,
