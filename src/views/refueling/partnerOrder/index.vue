<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
        <el-input v-model="orderId" style="width:200px;margin-right:10px;margin-bottom:10px" prefix-icon="el-icon-search" placeholder="请输入订单号" clearable></el-input>
        <!-- <el-input v-model="username" style="width:200px;margin-right:10px;margin-bottom:10px" prefix-icon="el-icon-search" placeholder="请输入加盟商ID" clearable></el-input>
        <el-input v-model="agentName" style="width:200px;margin-right:10px;margin-bottom:10px" prefix-icon="el-icon-search" placeholder="请输入加盟商名称" clearable></el-input> -->
        <el-input v-model="gasName" style="width:200px;margin-right:10px;margin-bottom:10px" prefix-icon="el-icon-search" placeholder="请输入加油站名称" clearable></el-input>
        <el-input v-model="userPhone" style="width:200px;margin-right:10px;margin-bottom:10px" prefix-icon="el-icon-search" placeholder="请输入用户手机号" clearable></el-input>
      ...
      <div v-show="!listLoading" class="pagination-container">
        <el-pagination
          ...
          :total="total"
        ></el-pagination>
        <div class="footer_total">原价金额合计：<span class="total_money">￥{{ Number(totalMoney).toFixed(2) }}</span></div>
      </div>
  </div>
</template>
