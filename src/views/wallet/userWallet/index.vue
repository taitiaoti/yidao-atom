<template>
    <div style="padding: 10px;">
        <div>
            ...
            <el-input v-model="agentId" clearable style="width: 200px;" placeholder="请输入代理人ID"></el-input>
...
<script>
    import { fetchUserWallet, updateUserWallet } from '@/api/dongdong/userWallet'
    ...
    export default {
        ...
        methods: {
            async getList(){
                ...
                const res = await fetchUserWallet(postData);
