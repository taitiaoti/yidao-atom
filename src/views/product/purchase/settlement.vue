            ...
            <el-form-item label="商品清单">
                ...
                <el-row :gutter="20" style="margin-top: 15px;">
                    ...
                    <el-col :span="3" class="price-wrapper">
                        <span class="price">￥{{total | filterPrice}}</span>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="21" class="num-wrapper">
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="3" class="price-wrapper">
                        <span class="price">￥{{dealPay(total, freight)}}</span>
                        <!-- <span class="price" v-if="freight != 0">￥{{dealPay(total, freight)}}</span>
                        <span class="price" v-if="freight == 0">￥{{dealPay(total, freight)}}(不含运费)</span> -->
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="20">
                    <el-col :span="24" class="submit-order">
                        ...
                        <el-button type="primary" :disabled="!isSubmit" @click="submitOrder">提交订单</el-button>
                    </el-col>
                </el-row>
            </el-form-item>
        </el-form>
...
<script>
    ...
    getAddressList ,addAddress, update, delAddress, setDefaultAddress, getBalance, 
        ...
        methods: {
            ...
            async submitOrder(){
                let postData = {
                    ...
                    skus: this.getSkusAndNum(),
                    jdAmount: this.dealPay(this.total, this.freight)
                }

                this.$alert('已选好商品确定下单', '下单', {
                    confirmButtonText: '确定',
                    callback: async action => {
                        if(action == 'confirm'){
                            const res = await buyProduct(postData);
                            console.log(res, '下单');
                            this.$notify({
                            ...
                            this.$store.dispatch('cart/checkout', this.cartSelectItems);
                            this.$router.push({
