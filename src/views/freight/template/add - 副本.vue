        ...
        <div class="freight-wrapper">
            ...
            <el-form ref="form" :model="form" label-width="150px" :rules="rules">
                    ...
                    <div class="shipping-wrapper">     
                        ...
                        <el-table
                            ...
                            <el-table-column label="操作">
                                <template scope="scope">
                                    <el-button @click="deleteFreight(scope.$index, scope.row.id)" size="mini">删除</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                            ...
                            <el-table-column label="设置包邮条件" width="350">
                                <template scope="scope">
                                    ...
                                    <div v-if="scope.row.condition && scope.row.condition.length != 2">
                                        ...
                                        <span>{{scope.row.condition | filterText}}内包邮</span>
                                    </div>
                                    <div v-if="scope.row.condition && scope.row.condition.length == 2">
                                        <span>在</span>
                ...
                <el-form-item>
                    ...
                    <el-button @click="submit('form')" v-if="form.isPost == 0">保存并返回1</el-button>
                    <el-button @click="submitTwo('form')" v-else>保存并返回2</el-button>
        ...
        methods: {
            ...
            handleSelectProvice(){
                ...
                this.checkedList.forEach(item => {
                    this.tableData.forEach((item02, index02) => {
                        if(item == Number(item02.provinceId)){
                            isAdd = true;
                            index = index02;
                        }
                    })
                    if(isAdd){
                        temArr.push(this.tableData[index]);
                    }else {
                        temArr.push({
                            provinceId: item,
                            firstWeight: 0,
                ...
                this.tableData = Object.assign([], temArr);
                this._tableDataDeffi(this.tableData);
            ...
            handleSelectProvice02(){
                ...
                this.checkedList02.forEach(item => {
                    ...
                    if(isAdd){
                        temArr.push(this.tableData02[index]);
                    }else {
                        temArr.push({
                            provinceId: item,
                            shipperCode: '',
                ...
                this.tableData02 = Object.assign([], temArr);
                this._tableDataDeffi02(this.tableData02);
            ...
            handleSelectProvice03(){
                ...
                this.checkedList03.forEach(item => {
                    ...
                    if(isAdd){
                        temArr.push(this.tableData03[index]);
                    }else {
                        temArr.push({
                            provinceId: item,
                            shipperCode: '',
                ...
                this.tableData03 = Object.assign([], temArr);
                this._tableDataDeffi03(this.tableData03);
